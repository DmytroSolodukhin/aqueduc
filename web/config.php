...
$majorReasons = $symfonyRequirements->getFailedRequirements();
$minorReasons = $symfonyRequirements->getFailedRecommendations();
            ...
            <div class="sf-reset">
                <div class="block">
                    <div class="symfony-block-content">
                        ...
                        <?php if (count($majorReasons)): ?>
                            <h2 class="ko">Major problems</h2>
                            <p>Major problems have been detected and <strong>must</strong> be fixed before continuing:</p>
                            <ol>
                                <?php foreach ($majorReasons as $problem): ?>
                        ...
                        <?php if (count($minorReasons)): ?>
                            <h2>Recommendations</h2>
                            <p>
                                <?php if (count($majorReasons)): ?>Additionally, to<?php else: ?>To<?php endif; ?> enhance your Symfony experience,
                                it’s recommended that you fix the following:
                            </p>
                            <ol>
                                <?php foreach ($minorReasons as $problem): ?>
                                    <li><?php echo $problem->getTestMessage() ?>
                                        <p class="help"><em><?php echo $problem->getHelpHtml() ?></em></p>
                                    </li>
                                <?php endforeach; ?>
                        ...
                        <?php if (!count($majorReasons) && !count($minorReasons)): ?>
